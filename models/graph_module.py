...
class GraphModule(nn.Module):
    ...
    def _query_locals(self, det_dict, target_ids, object_masks, include_self=True, overlay_threshold=CONF.TRAIN.OVERLAID_THRESHOLD):
        corners = det_dict["bbox_corner"] # batch_size, num_proposals, 8, 3
    ...
    def _create_adjacent_mat(self, det_dict, object_masks):
        ...
        for obj_id in range(num_objects):
            target_ids = torch.LongTensor([obj_id for _ in range(batch_size)]).type_as(object_masks)
